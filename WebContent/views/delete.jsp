...
<body>
	...
	<form action="/MemberInformation/jp/co/aforce/controller/DeleteController" method="post">
		...
		<ul>
			...
			<li>会員番号<br>
				 <input type="text" id="member_id" name="member_id" maxlength="13" value="${mb.member_id}">
		...
		<div>
			...
			<input type="submit" id="submit" formmethod="post" value="削除">
		</div>
